<div class="list-group">
      ...
      <a href="installningar_aktuelltschema.php" class="list-group-item">Schemaperioder</a>
      ...
      <a href="installningar_kontaktmedlemmar.php" class="list-group-item">Meddela alla medlemmar</a>
